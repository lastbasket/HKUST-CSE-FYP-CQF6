...
from model.networks.graph_layers import spmm
...
class Mesh(object):
    ...
    def __init__(self, smal, filename='./data/mesh_down_sampling.npz',
        ...
        ref_vertices = smal.v_template.clone()
    ...
    def ref_vertices(self):
        ...
        for i in range(self.num_downsampling):
            ref_vertices = torch.spmm(self._D[i].to(ref_vertices.device), ref_vertices)
        return ref_vertices
