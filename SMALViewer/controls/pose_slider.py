...
class PoseSlider(QWidget):
    ...
    def setValue(self, value):
        ...
        self.x_slider.setValue(self.__rot_to_slider_int(value[0]).astype(np.int))
        self.y_slider.setValue(self.__rot_to_slider_int(value[1]).astype(np.int))
        self.z_slider.setValue(self.__rot_to_slider_int(value[2]).astype(np.int))
